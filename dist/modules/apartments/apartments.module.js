...
const apartments_controller_1 = require("./controllers/apartments.controller");
...
ApartmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [apartments_service_1.ApartmentsService, apartment_repository_1.ApartmentRepository],
        exports: [apartment_repository_1.ApartmentRepository],
    })
], ApartmentsModule);
