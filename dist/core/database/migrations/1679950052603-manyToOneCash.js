...
exports.manyToOneCash1679950052603 = void 0;
class manyToOneCash1679950052603 {
    constructor() {
        this.name = 'manyToOneCash1679950052603';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`resident_cash\` ADD \`resident_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`resident_cash\` ADD \`apartment_id\` int NULL`);
...
exports.manyToOneCash1679950052603 = manyToOneCash1679950052603;
//# sourceMappingURL=1679950052603-manyToOneCash.js.map