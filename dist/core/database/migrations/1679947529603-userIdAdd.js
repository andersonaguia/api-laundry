...
exports.userIdAdd1679947529603 = void 0;
class userIdAdd1679947529603 {
    constructor() {
        this.name = 'userIdAdd1679947529603';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`resident_cash\` ADD \`user_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`resident_cash\` ADD UNIQUE INDEX \`IDX_66e776fba6771259dc383636e1\` (\`user_id\`)`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`command_machines\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`apartments\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`resident_cash\` DROP INDEX \`IDX_66e776fba6771259dc383636e1\``);
        await queryRunner.query(`ALTER TABLE \`resident_cash\` DROP COLUMN \`user_id\``);
    }
}
exports.userIdAdd1679947529603 = userIdAdd1679947529603;
//# sourceMappingURL=1679947529603-userIdAdd.js.map