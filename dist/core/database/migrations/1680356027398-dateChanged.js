...
exports.dateChanged1680356027398 = void 0;
class dateChanged1680356027398 {
    constructor() {
        this.name = 'dateChanged1680356027398';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`system_config\` DROP COLUMN \`minimumUsageTime\``);
        await queryRunner.query(`ALTER TABLE \`system_config\` ADD \`minimumUsageTime\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`system_config\` CHANGE \`user_id\` \`user_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`system_config\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`system_config\` CHANGE \`user_id\` \`user_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`system_config\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
...
exports.dateChanged1680356027398 = dateChanged1680356027398;
//# sourceMappingURL=1680356027398-dateChanged.js.map